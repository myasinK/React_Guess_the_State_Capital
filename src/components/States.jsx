...
export class Alabama extends Component {
  render() {
    const stateAbbr = this.props.id;
    return (
      <path
        id={stateAbbr}
        onClick={() => this.props.onClick(stateAbbr)}
...
export class Alaska extends Component {
  render() {
    const stateAbbr = this.props.id;
    return (
      <path
...
export class Arizona extends Component {
  render() {
    const stateAbbr = this.props.id;
    return (
      <path
...
export class Arkansas extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
        id={stateAbbr}
        onClick={() => this.props.onClick(stateAbbr)}
...
export class Colorado extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Connecticut extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Dc extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <g id={stateAbbr} onClick={() => this.props.onClick(stateAbbr)}>
...
export class Delaware extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Florida extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Georgia extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Idaho extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Illinois extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Indiana extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Iowa extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Kansas extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Kentucky extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Louisiana extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Maine extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Maryland extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Massachusetts extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Michigan extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Minnesota extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Mississippi extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Missouri extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Montana extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Nebraska extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Nevada extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Newhampshire extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Newjersey extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Newmexico extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Newyork extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Northcarolina extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Northdakota extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Ohio extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Oklahoma extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Oregon extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Pennsylvania extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Rhodeisland extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Southcarolina extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Southdakota extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Tennessee extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Texas extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Utah extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Vermont extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Virginia extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Washington extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Westvirginia extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Wisconsin extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
...
export class Wyoming extends Component {
  render() {
    let stateAbbr = this.props.id;
    return (
      <path
